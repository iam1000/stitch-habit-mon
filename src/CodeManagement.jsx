...
const CodeManagement = () => {
    ...
    return (
        <div className="p-6 lg:p-12 h-screen flex flex-col box-border overflow-hidden">
            {/* 헤더 섹션 (Investment 스타일) */}
            <header className="mb-6 flex-none">
                <h1 className="text-3xl font-bold text-[var(--text-main)] mb-2 font-heading">코드 관리</h1>
                <p className="text-gray-500 text-sm">시스템에서 사용하는 공통 코드를 그룹별로 관리하고 통제합니다.</p>
            </header>
